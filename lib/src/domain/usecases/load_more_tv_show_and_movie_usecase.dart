...
class LoadMoreTvShowAndMovieGenrePageUseCase
    implements UseCase<DataState<List<TvShowAndMovie>>, PaginationType> {
  LoadMoreTvShowAndMovieGenrePageUseCase(this._tvShowAndMovieRepository);

  final TvShowAndMovieRepository _tvShowAndMovieRepository;

  @override
  Future<DataState<List<TvShowAndMovie>>> call(PaginationType params) {
    return _tvShowAndMovieRepository.loadMoreTvShowAndMovieGenrePage(params);
  }
}
