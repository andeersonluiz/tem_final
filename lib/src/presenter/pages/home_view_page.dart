...
class _HomeViewPageState extends State<HomeViewPage> {
  final TvShowsAndMoviesController tvShowAndMovieController =
      Get.find<TvShowsAndMoviesController>();
  ...
  void _scrollListener() {
    if (controller.position.extentAfter < 500 &&
        !tvShowAndMovieController.isLoadingMore) {
      print("loadingMore...");
      tvShowAndMovieController.loadMore();
    }
  }
            ...
            switch (
              ...
              case StatusLoadingTvShowAndMovie.sucess:
                return _buildListTvShowAndMovie(
                    tvShowAndMovieController.listTvShowAndMovie, controller);
            }
          })
        ],
      ),
